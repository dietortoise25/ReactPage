...
function V1Page() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch('/product_specifications.json')
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <p className="text-slate-700 font-light text-lg tracking-wide">Loading products...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="text-center py-32">
            <div className="relative">
              ...
              <div className="relative p-12">
                <p className="text-slate-600 text-xl font-light tracking-wide">No products found</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="relative">
            ...
            <div className="relative p-8 text-center">
              <p className="text-red-600 font-light tracking-wide">
                Smart Watch Collection — Professional Wearable Technology Solutions
              </p>
            </div>
          </div>
        </div>
